/*! ng-cells 2014-03-10 Copyright 2013,2014 Guy de Pourtalès. Licensed under the Apache License, Version 2.0 */
...
}]).directive("ngcRange",function(){return{require:"^ngcTable",restrict:"AE",scope:{top:"=",bottom:"=",left:"=",right:"=",formatFn:"=?",customHtmlFn:"=?",customTrustedHtmlFn:"=?",clazz:"=?",styleFn:"=?",clickFn:"=?",dblclickFn:"=?",keydownFn:"=?",keypressFn:"=?",keyupFn:"=?",mousedownFn:"=?",mouseenterFn:"=?",mouseleaveFn:"=?",mousemoveFn:"=?",mouseoverFn:"=?",mouseupFn:"=?"},link:function(a,b,c,d){d.addRange({top:a.top,bottom:a.bottom,left:a.left,right:a.right,formatFn:a.formatFn,clazz:a.clazz,styleFn:a.styleFn,customHtmlFn:a.customHtmlFn,customTrustedHtmlFn:a.customTrustedHtmlFn,click:a.clickFn,dblclick:a.dblclickFn,keydown:a.keydownFn,keypress:a.keypressFn,keyup:a.keyupFn,mousedown:a.mousedownFn,mouseenter:a.mouseenterFn,mouseleave:a.mouseleaveFn,mousemove:a.mousemoveFn,mouseover:a.mouseoverFn,mouseup:a.mouseupFn,touchstart:a.touchstartFn,touchmove:a.touchmoveFn,touchend:a.touchendFn})}}}).directive("ngcScrollbar",["$timeout","contentUpdatedEvent",function(a,b){return{require:"^ngcTable",restrict:"A",replace:!0,template:'<div class="ngc"></div>',compile:function(c,d){return{pre:function(a,b){var c=100;if(angular.isDefined(d.horizontal))angular.isDefined(a.data[0])&&(c=(a.data[0].length-a.$$leftFixedColumns.length-a.$$rightFixedColumns.length)/a.$$variableCenterColumns.length*100),b.addClass("hscrollbar"),b.css("width",Math.ceil(c)+"%"),100>=c&&b.parent().css("display","none"),a.$$horizontalScrollbarElement=b,a.$$horizontalScrollbarWrapperElement=b.parent()[0];else if(angular.isDefined(d.vertical)){angular.isDefined(a.data)&&(c=(a.data.length-a.$$headerRows.length-a.$$footerRows.length)/a.$$rows.length*100),b.addClass("vscrollbar"),b.css("height",c+"%"),100>=c&&b.parent().css("display","none");var e=a.$parent.$parent;e.$$verticalScrollbarElement=b,e.$$verticalScrollbarWrapperElement=b.parent()[0]}},post:function(c,d){var e,f,g=120,h=g,i=500,j=d.parent(),k=function(a){var b,d=c.$$verticalScrollbarWrapperElement.scrollTop,e=c.$$horizontalScrollbarWrapperElement.scrollLeft;if(angular.element(a.target).hasClass("horizontal"))b=a.target.scrollLeft/a.target.scrollWidth,c.$$scrollPosition.left=Math.round(b*(c.data[0].length-c.$$leftFixedColumns.length-c.$$rightFixedColumns.length));else{if(!angular.element(a.target).hasClass("vertical"))return;b=a.target.scrollTop/a.target.scrollHeight,c.$$scrollPosition.top=Math.round(b*(c.data.length-c.$$headerRows.length-c.$$footerRows.length))}angular.isFunction(c.scrollFn)&&c.scrollFn(a,{top:c.$$scrollPosition.top+c.$$headerRows.length,left:c.$$scrollPosition.left+c.$$leftFixedColumns.length}),c.$$updateData(),c.$apply(),c.$$verticalScrollbarWrapperElement.scrollTop=d,c.$$horizontalScrollbarWrapperElement.scrollLeft=e,l()},l=function(){a(function(){if(d.hasClass("vscrollbar")){var a=(c.data.length-c.$$headerRows.length-c.$$footerRows.length)/c.$$rows.length,b=angular.element(c.$$verticalScrollbarWrapperElement),e=b.parent()[0].offsetHeight;b.css("height",e+"px"),d.css("height",e*a+"px")}})};j.on("wheel",function(){f&&clearTimeout(f),h=i,f=setTimeout(function(){h=g},i)}),j.on("scroll",function(a){e&&clearTimeout(e),e=setTimeout(angular.bind(this,k,a),h)}),l(),c.$on(b,l)}}}}}])}();